...
const HeroContent = () => {
  return (
    ...
    initial='hidden'
    animate='visible'
    className='flex flex-row items-center justify-center px-20 mt-[64px] w-full z-[20] h-[calc(100vh-64px)]'
    >
      <div className='h-full w-full flex flex-col gap-5 justify-center m-auto text-start'>
        ...
        >
          ...
          experience in the IT field. Check out my projects and skills.
        </motion.p>
        <motion.a
